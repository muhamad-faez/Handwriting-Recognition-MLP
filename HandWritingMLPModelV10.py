...
class HandWritingMLPModelV10(nn.Module):
    def __init__(self):
        super(HandWritingMLPModelV10, self).__init__()
        self.flatten = nn.Flatten()
        # Define the fully connected layers along with batch normalization
        self.fc1 = nn.Linear(128*128, 2048)
        ...
        self.bn4 = nn.BatchNorm1d(216)
        self.fc5 = nn.Linear(216, 62)
